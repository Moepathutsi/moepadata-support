...
$config = [
    ...
    'settings_apis' => [
        [
            ...
            'label' => 'lang:openai_max_tokens',
            'rules' => 'required|greater_than_equal_to[1]'
        ],
        [
            'field' => 'openai_temperature',
            'label' => 'lang:openai_temperature',
            'rules' => 'required|greater_than_equal_to[0]'
        ],
        [
            'field' => 'openai_frequency_penalty',
            'label' => 'lang:openai_frequency_penalty',
            'rules' => 'required|greater_than_equal_to[0]'
        ],
        [
            'field' => 'openai_presence_penalty',
            'label' => 'lang:openai_presence_penalty',
            'rules' => 'required|greater_than_equal_to[0]'
        ],
        [
            'field' => 'openai_top_p',
            'label' => 'lang:openai_top_p',
