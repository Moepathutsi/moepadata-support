...
class Account extends MY_Controller {
    ...
    {
        if ( $this->form_validation->run( 'delete_account' ) )
        {
            $id = $this->zuser->get( 'id' );
            ...
            if ( db_config( 'u_temporary_lockout' ) !== 'off' )
            {
                user_locally_locked_check( $id, 'delete_account' );
            }

            if ( ! password_verify( post( 'password' ), $this->zuser->get('password') ) )
            {
                $this->Login_model->log_invalid_attempt( $id, 'delete_account' );
                r_error( 'wrong_password' );
            }
            ...
            if ( delete_user( $id ) )
            {
                $this->Login_model->delete_invalid_attempt( $id, 'delete_account' );
