...
class Support extends MY_Controller
{
    ...
    public function chat($id = 0)
    {
        ...
        $data['data']['ai_write_for_fields'] = AI_WRITE_FOR_FIELDS['view_chat'];
        $data['data']['chat'] = $chat;
    ...
    public function canned_replies()
    {
        ...
        $data['data']['ai_write_for_fields'] = AI_WRITE_FOR_FIELDS['tickets_canned_replies'];
    ...
    public function faqs($page = 'list')
    {
        ...
        $data['data']['ai_write_for_fields'] = AI_WRITE_FOR_FIELDS['faq'];
    ...
    public function create_ticket()
    {
        ...
        $data['data']['ai_write_for_fields'] = AI_WRITE_FOR_FIELDS['create_ticket'];
    ...
    public function ticket($id = 0)
    {
        ...
        $data['data']['tasks'] = $this->Support_model->ticket_tasks(['ticket_id' => $id]);
        ...
        $data['data']['ai_write_for_fields'] = AI_WRITE_FOR_FIELDS['view_ticket'];
    ...
    public function articles($type = 'list', $id = 0)
    {
        ...
        $data['data']['ai_write_for_fields'] = AI_WRITE_FOR_FIELDS['article'];
        $data['title'] = $page_title;
        $this->load_panel_template($data);
    }
}
