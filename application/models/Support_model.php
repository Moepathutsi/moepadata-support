...
class Support_model extends MY_Model
{
     ...
     * @version 2.3
     */
    public function ticket_tasks(array $options)
    {
        $data['select'] = 'tt.*, u.username';
        $data['table'] = 'tickets_tasks tt';
        $data['join'] = ['table' => 'users u', 'on' => 'u.id = tt.user_id'];
        $data['where'] = ['tt.ticket_id' => $options['ticket_id']];
     ...
     * @version 2.3
     */
    public function ticket_task($id)
    {
        $data['where'] = ['id' => $id];
        $data['table'] = 'tickets_tasks';
     ...
     * @version 2.3
     */
    public function add_ticket_task($data)
    {
        return $this->add($data, 'tickets_tasks');
    }
     ...
     * @version 2.3
     */
    public function update_ticket_task($to_update, $id)
    {
     ...
     * @version 2.3
     */
    public function delete_ticket_task($id)
    {
        $data['where']['id'] = $id;
        $data['table'] = 'tickets_tasks';
     ...
     * @version 2.3
     */
    public function delete_ticket_tasks($id)
    {
    ...
    /**
     * Pending Tasks (of Ticket)
     *
     * @param   integer $id Ticket ID
     * @return  void
     * @version 2.3
     */
    public function pending_tasks($id)
    {
        $data['where'] = ['ticket_id' => $id, 'status' => TASK_PENDING];
        $data['table'] = 'tickets_tasks';
    ...
    /**
     * Save Ticket Reply Quote
     *
     * @param   array $data
     * @return  mixed
     * @version 2.2
     */
    public function save_ticket_reply_quote($data)
    {
        return $this->add($data, 'tickets_replies_quotes');
    }

    /**
     * Delete Ticket Reply Quotes
     *
     * @param   integer $id
     * @return  boolean
     * @version 2.2
     */
    public function delete_ticket_reply_quotes($id)
    {
        $data['table'] = 'tickets_replies_quotes';
     ...
     * @version 2.2
     */
    public function ticket_from_email($subject, $email_address)
    {
        $data['where'] = [
            'subject' => $subject,
    ...
    /**
     * Get Message-ID by Ticket ID
     *
     * @param   integer $ticket_id
     * @return  string
     * @version 2.2
     */
    public function get_message_id_by_ticket_id($ticket_id)
    {
        // Order: Desc
        ...
        $data['table'] = 'tickets_emails';

        $record = $this->get_one($data);
     ...
     * @version 2.2
     */
    public function log_ticket_email($ticket_id, $message_id)
    {
        $data = [
            'ticket_id' => $ticket_id,
        ...
        return $this->add($data, 'tickets_emails');
    }

    /**
     * Delete Logged Email Ticket References
     *
     * @param   integer $ticket_id
     * @return  boolean
     * @version 2.2
     */
    public function delete_logged_email_ticket_references($ticket_id)
    {
        $data['where']['ticket_id'] = $ticket_id;
        $data['table'] = 'tickets_emails';
     ...
     * @version 2.2
     */
    public function ticket_email($references = '')
    {
        $ids = [];
    ...
    public function tickets_replies($ticket_id)
    {
        ...
        $select .= 'u.picture as user_picture, trq.message as quoted_message';

        $data['select'] = $select;
        $data['table'] = 'tickets_replies tr';

        $data['join'] = [
            ['table' => 'users u', 'on' => 'u.id = tr.user_id'],
            ['table' => 'tickets_replies_quotes trq', 'on' => 'trq.ticket_reply_id = tr.id'],
        ];
     ...
     * @param  boolean $sub_status
     * @return boolean
     */
    public function update_ticket_status($id, $status, $closed_by = '', $sub_status = true)
    {
        $data['column_value'] = $id;
        $data['table'] = 'tickets';
    ...
    public function auto_close_tickets()
    {
        ...
        if (! empty($to_close)) {
            foreach ($to_close as $ticket) {
                if (!$this->Support_model->pending_tasks($ticket->id)) {
