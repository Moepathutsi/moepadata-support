...
<?php if (db_config('sp_live_chatting')) {
    ...
    <div id="chat-box" class="chat-box position-fixed shadow-lg rounded bg-white">
        <div class="chat-box-header border-bottom py-3 px-4">
            <div class="d-flex">
                    ...
                    <?php if ($is_active_chat) { ?>
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end border-0 shadow-lg" aria-labelledby="chat-box-menu">
                                <li><a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#end-chat"><i class="fas fa-check"></i> <?php echo lang('end_chat'); ?></a></li>
                            </ul>
                        </div>
                        <!-- /.dropdown -->
                    <?php } ?>
        ...
        <div id="chat-box-body" class="chat-box-body">
            ...
            <?php } else if ($is_active_chat) {
                ...
                <form class="z-form add-reply-chat" action="<?php user_action('support/add_reply_chat'); ?>" method="post" data-dark="true">
                    ...
                    <div id="chat-messages" class="chat-messages p-4" data-chat-action="<?php user_action('support/get_chat_messages'); ?>">
                        ...
                        <?php if (! empty($messages)) {
                            ...
                            <div class="chat-message requestor">
                                <small class="text-center d-block mb-3 text-sub fw-bold"><?php echo replace_some_with_actuals(html_escape($chat->subject)); ?></small>
                                ...
                                <?php if (empty($messages['replies'])) { ?>
                                    <small class="text-center d-block mt-3 text-sub"><?php echo lang('waiting_agent'); ?></small>
                                <?php } ?>
                            </div>
                            <!-- /.chat-message -->
                        <?php } ?>
                    ...
                    <div class="d-flex">
                        ...
                        <div>
                            <button class="btn btn-light btn-simple pe-4 h-100 rounded-0" type="submit"><i class="fas fa-paper-plane"></i></button>
                        </div>
                    </div>
                    <!-- /.d-flex -->
                </form>
