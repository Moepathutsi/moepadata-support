...
<head>
  ...
  <link href="https://fonts.googleapis.com/css2?family=Plus+Jakarta+Sans:ital,wght@0,200..800;1,200..800&family=Roboto+Slab:wght@100..900&display=swap" rel="stylesheet">
    ...
    <div class="container-fluid">
      ...
      <div class="d-flex">
        <?php if ($this->zuser->is_logged_in) { ?>
          <a class="text-muted me-3 d-lg-none" href="<?php echo env_url('user/notifications'); ?>">
            <div class="d-flex">
              <div>
      ...
      <div class="collapse navbar-collapse" id="navbar">
        ...
        <ul class="navbar-nav d-block d-lg-flex align-items-center auth-btns">
          <?php if (! $this->zuser->is_logged_in) {
                ...
                <?php if (db_config('module_tickets') == 1) { ?>
                  <li>
                    <a class="dropdown-item <?php echo user_panel_activate_sub_child_page('create_ticket'); ?>" href="<?php echo env_url('user/support/create_ticket'); ?>">
                      <i class="fas fa-plus"></i> <?php echo lang('submit_ticket'); ?>
                    </a>
                  </li>
                  <li>
