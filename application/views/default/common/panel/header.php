...
<head>
    ...
    <script>
        ...
        const reachedAllowedFilesLimit = "<?php echo err_lang('reached_allowed_files_limit'); ?>";
...
<body class="hold-transition <?php echo get_body_classes(); ?>">
    ...
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light text-sm">
            ...
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link sidebar-toggle pl-2" data-widget="pushmenu" href="#" role="button">
            ...
            <div class="sidebar os-host-overflow">
                ...
                <?php if (db_config('maintenance_mode')) { ?>
                    <div class="bg-danger text-center p-2 mb-3 text-sm">
                        <span><i class="fas fa-check mr-1"></i> <?php echo lang('maintenance_mode'); ?></span>
                    </div>
                <?php } ?>
                        ...
                        <?php if ($this->zuser->has_permission('settings')) { ?>
                            <li class="nav-item has-treeview <?php echo panel_open_parent_menu('settings'); ?>">
                                ...
                                <ul class="nav nav-treeview">
                                    ...
                                    <li class="nav-item">
                                        <a href="<?php echo env_url('admin/settings/imap'); ?>" class="nav-link <?php echo panel_activate_sub_child_page('imap'); ?>">
                                            <i class="fas fa-inbox nav-icon"></i>
                                            <p><?php echo lang('imap'); ?></p>
                                        </a>
                                    </li>
                                </ul>
                            </li>
        ...
        <div class="content-wrapper pt-3">
            ...
            <?php if (db_config('i_pc_status') == 2) { ?>
                <div class="content">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="alert alert-warning text-center small"><?php echo db_config('err_invalid_detected'); ?></div>
                            </div>
                            <!-- /.col -->
                        </div>
                        <!-- /.row -->
