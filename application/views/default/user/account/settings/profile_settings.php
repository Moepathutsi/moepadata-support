        ...
        <div class="row">
            <div class="col-lg-3 mb-4 mb-lg-0">
                ...
                <div class="sticky-sidebar">
                    <div class="shadow-sm wrapper user-view text-center p-4 rounded">
            ...
            <div class="col-lg-9">
                ...
                <div class="shadow-sm wrapper rounded">
                    <form class="z-form" action="<?php user_action('account/update_profile_settings'); ?>" method="post" enctype="multipart/form-data" data-csrf="manual">
                        ...
                        <div class="border-bottom px-4 py-3">
                            <h5 class="fw-bold mb-0"><?php echo lang('general_settings'); ?></h5>
                        </div>
                        ...
                        <div class="p-4">
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    ...
                                    <input class="w-100" type="file" id="picture" name="picture" accept="<?php echo ALLOWED_IMG_EXT_HTML; ?>">
                                </div>
                                <!-- /col -->
                            </div>
                            <!-- /.row -->
                ...
                <!-- /.wrapper -->
                <div class="shadow-sm wrapper rounded mt-4">
                    <form class="z-form" action="<?php user_action('account/change_password'); ?>" method="post" data-csrf="manual">
                        <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">
                        <input type="hidden" name="area" value="user">

                        <div class="border-bottom px-4 py-3">
                            <h5 class="fw-bold mb-0"><?php echo lang('change_password'); ?></h5>
                        </div>
