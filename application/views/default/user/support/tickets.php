...
<div class="z-listing-tickets not-first bordered extra-height-1 container my-5">
    <div class="row mb-4">
        <div class="col d-lg-flex align-items-center justify-content-between">
            ...
            <div>
                <form class="search-form mt-3 mt-lg-0" action="<?php echo env_url('user/support/tickets/' . html_escape($this->uri->segment(4))); ?>">
                        ...
                        <div class="list-item">
                            <div class="row d-lg-flex align-items-center justify-content-between">
                                <div class="col-lg-1 ps-lg-3 pe-lg-0 align-self-center">
                                    <h3 class="h5 mb-3 mb-lg-0 rounded text-center bg-sub text-white py-2 fw-bold"><?php echo ticket_replies_count($ticket->id); ?></h3>
                                </div>
                                <!-- /col -->
                                <div class="col-lg-8">
