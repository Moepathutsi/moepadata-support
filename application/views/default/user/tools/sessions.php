    ...
    <div class="row mb-4">
        <div class="col d-lg-flex align-items-center justify-content-between">
            ...
            <?php if (! empty($sessions)) {
                if ($count > 1) { ?>
                    <div>
                        <button class="btn btn-dark w-100 mt-3 mt-lg-0" data-bs-toggle="modal" data-bs-target="#logout-others">
                            <small><i class="fas fa-minus me-2"></i> <?php echo lang('logout_my_others'); ?></small>
                        </button>
                    </div>
            <?php }
            } ?>
