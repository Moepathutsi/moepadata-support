    ...
    <?php if (db_config('module_tickets') == 1) { ?>
        <div class="row no-flex sep-col text-center">
            <div class="col-lg-4 col-sm-6 mb-3">
                <div class="text-white bg-sub p-4 rounded">
                    <p class="h2 mb-1 fw-bold"><?php echo html_escape($opened); ?></p>
            ...
            <div class="col-lg-4 col-sm-6 mb-3">
                <div class="text-white bg-sub p-4 rounded">
                    <p class="h2 mb-1 fw-bold"><?php echo html_escape($closed); ?></p>
            ...
            <div class="col-lg-4 col-sm-6 mb-3">
                <div class="text-white bg-sub p-4 rounded">
                    <p class="h2 mb-1 fw-bold"><?php echo html_escape($all); ?></p>
                        ...
                        foreach ($tickets as $ticket) { ?>
                            <div class="list-item">
                                <div class="row d-lg-flex align-items-center justify-content-between">
                                    <div class="col-lg-1 ps-lg-3 pe-lg-0 align-self-center">
                                        <h5 class="mb-3 mb-lg-0 rounded text-center bg-sub text-white py-2 fw-bold"><?php echo ticket_replies_count($ticket->id); ?></h5>
                                    </div>
                                    <!-- /col -->
                                    <div class="col-lg-8">
                                        <p class="h5 mb-2 mb-lg-1 fw-bold">
                                            ...
                                            <?php if ($ticket->is_read == 0 && ($ticket->sub_status == 2 || $ticket->sub_status == 3)) { ?>
                                                <span class="text-danger">(<?php echo lang('unread'); ?>)</span>
                                            <?php } ?>
                                        </p>
                                    ...
                                    <!-- /col -->
                                    <div class="col-lg-3">
                                        <div class="float-lg-end mt-3 mt-lg-0 text-lg-end">
