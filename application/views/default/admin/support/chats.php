      ...
      <div class="col-sm-12">
        ...
        <div class="card">
          ...
          <div class="card-body pt-0 pb-0 records-card-body">
            <form class="z-form" action="<?php echo admin_action('support/bulk_chats_action'); ?>" method="post">
                ...
                <div class="row">
                  <div class="col">
                    <select class="form-control select2 search-disabled" name="action" data-placeholder="<?php echo lang('select_action'); ?>" required>
                      <option value=""></option>
                      <option value="end"><?php echo lang('end'); ?></option>
                    ...
                    if (! empty($chats)) {
                      foreach ($chats as $chat) { ?>
                        <tr id="record-<?php echo html_escape($chat->id); ?>">
                          <td>
                            <div class="icheck icheck-primary d-inline-block">
                              <input class="checkbox-item" type="checkbox" id="checkbox-<?php echo intval($chat->id); ?>" value="<?php echo intval($chat->id); ?>" name="ids[]">
                              <label for="checkbox-<?php echo intval($chat->id); ?>"></label>
                            </div>
                          </td>
