          ...
          <div class="card">
            <div class="card-header d-flex align-items-center">
              ...
              <div class="ml-auto">
                ...
                <?php if (is_openai_ready()) { ?>
                  <button type="button" class="btn btn-success text-sm ml-1" data-toggle="modal" data-target="#ai-writer">
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <textarea class="form-control textarea" id="textarea" name="content" data-is-editor="true"><?php echo html_escape(do_secure($article->content, true)); ?></textarea>
              </div>
              <!-- /.form-group -->
              <div class="form-group">
