                        ...
                        <div class="card-body">
                            <div class="tab-content">
                                ...
                                <div class="tab-pane" id="appearance" role="tabpanel" aria-labelledby="appearance-tab">
                                    ...
                                    <div class="colors-radios">
                                        ...
                                        <label class="color-wrapper">
                                            <input type="radio" name="site_color" value="4" <?php echo check_single(4, db_config('site_color')); ?>>
                                            <span class="check-circle color_4"></span>
                                        </label>
                                        <label class="color-wrapper">
                                        ...
                                        <label class="color-wrapper">
                                            <input type="radio" name="site_color" value="5" <?php echo check_single(5, db_config('site_color')); ?>>
                                            <span class="check-circle color_5"></span>
                                        </label>
                                        <label class="color-wrapper">
                                ...
                                <div class="tab-pane" id="custom-js" role="tabpanel" aria-labelledby="custom-js-tab">
                                    <label for="site-custom-js"><?php echo lang('custom_js'); ?></label>
                                    <textarea id="site-custom-js" class="form-control" name="site_custom_js" rows="5"><?php echo html_escape(db_config('site_custom_js')); ?></textarea>
