...
<form class="z-form" action="<?php admin_action('tools/update_announcement'); ?>" method="post">
    ...
    <div class="modal-body">
        ...
        <textarea class="form-control textarea" id="announcement-edit" name="announcement" data-is-editor="true" rows="5" required><?php echo html_escape($announcement); ?></textarea>
    </div>
    <!-- /.modal-body -->
