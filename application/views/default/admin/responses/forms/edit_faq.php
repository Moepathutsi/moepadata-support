...
<form class="z-form" action="<?php admin_action('support/update_faq'); ?>" method="post">
    ...
    <div class="modal-body">
        ...
        <div class="form-group">
            ...
            <textarea class="form-control textarea" id="answer-edit" name="answer" data-is-editor="true" rows="5" required><?php echo html_escape($answer); ?></textarea>
        </div>
        <!-- /.form-group -->
        <div class="form-group">
        ...
        <div class="form-row">
            <div class="mb-3 mb-md-0 col-md-6">
                <label for="logged-in-only-edit"><?php echo lang('for_logged_in_only'); ?></label>
                <select class="form-control select2 search-disabled" id="logged-in-only-edit" name="logged_in_only">
                    <option value="0" <?php echo select_single(0, $logged_in_only); ?>><?php echo lang('no'); ?></option>
                    <option value="1" <?php echo select_single(1, $logged_in_only); ?>><?php echo lang('yes'); ?></option>
                </select>
            </div>
            <!-- /.col -->
            <div class="col-md-6">
    ...
    <div class="modal-footer">
        <?php if (is_openai_ready()) { ?>
            <button type="button" class="btn btn-success mr-auto modal-button text-sm" data-toggle="modal" data-target="#ai-writer" data-modal-type="edit"><i class="fas fa-robot mr-2"></i> <?php echo lang('ai_writer'); ?></button>
        <?php } ?>
