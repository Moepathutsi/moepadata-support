            ...
            <form class="z-form" action="<?php admin_action('ai_writer/generate'); ?>" method="post">
                ...
                <div class="modal-body pb-0">
                    ...
                    <div class="form-group">
                        <label for="action-ai"><?php echo lang('what_can_i_do_ai'); ?> <span class="text-danger" *></span></label>
                        <select id="action-ai" class="form-control select2 search-disabled" name="action" required>
                            <option value="Make Better"><?php echo lang('make_better'); ?></option>
                            <option value="Correct Grammar"><?php echo lang('correct_grammar'); ?></option>
                            <option value="Provide Answer"><?php echo lang('provide_answer'); ?></option>
                        </select>
                    </div>
                    <!-- /.form-group -->
                    <div class="form-group">
                        <label for="content-ai"><?php echo lang('content'); ?> <span class="text-danger">*</span></label>
                        <textarea id="content-ai" class="form-control" name="content" rows="3" required></textarea>
                    </div>
                    <!-- /.form-group -->
                    <div class="form-group">
