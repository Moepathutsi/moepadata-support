            ...
            <form class="z-form" action="<?php admin_action('support/add_faq'); ?>" method="post">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control textarea" id="answer-add" name="answer" data-is-editor="true" rows="5" required></textarea>
                    </div>
                    <!-- /.form-group -->
                    <div class="form-group">
                    ...
                    <div class="form-row">
                        <div class="mb-3 mb-md-0 col-md-6">
                            <label for="logged-in-only-add"><?php echo lang('for_logged_in_only'); ?></label>
                            <select class="form-control select2 search-disabled" id="logged-in-only-add" name="logged_in_only">
